...
def report(
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"*Параметры генерации:* Top-K категорий = {top_k_categories}, макс. гистограмм = {max_hist_columns}.\n\n")
        ...
        f.write(f"- Есть категориальные с высокой кардинальностью (>100): **{quality_flags['has_high_cardinality_categoricals']}**\n\n")
    ...
    typer.echo(f"\nИспользованы настройки: Заголовок = '{title}', Top-K категорий = {top_k_categories}, макс. гистограмм = {max_hist_columns}.")
